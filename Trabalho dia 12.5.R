...
# Corte Transversal (Ano de Referência)
# Descrição: Gráfico de barras mostrando os gastos militares como porcentagem 
# do PIB para os países selecionados, em um ano específico (como 2022 ou o mais 
# recente disponível).
...
# Série Temporal Focada (Brasil)
# Descrição: Este gráfico mostra a evolução dos gastos militares do Brasil ao 
# longo do tempo, convertidos para valores em bilhões de reais. O eixo 
# horizontal está em intervalos de 10 anos.
...
# O gasto como proporção do PIB pode parecer pequeno, mas em valores absolutos 
# representa uma fatia significativa dos investimentos do Estado.
